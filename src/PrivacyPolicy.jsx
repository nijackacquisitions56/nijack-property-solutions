        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '48px 40px', border: '2px solid #e8e0d0', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28, fontSize: 15, lineHeight: 1.9, color: '#444', fontWeight: 600 }}>
            ...
            <section>
              ...
              <p style={{ margin: 0 }}>Tekton Property Solutions LLC is a real estate solutions company based in Ohio. We help property owners explore options for selling residential and other real estate directly, often in as-is condition. We are not licensed real estate agents. We operate in Ohio.</p>
