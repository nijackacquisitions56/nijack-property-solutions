        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px' }}>
          {[
            ...
            <div key={i} style={{ padding: '15px 24px', textAlign: 'center', flex: '1 1 200px', minWidth: '160px' }}>
              <div style={{ color: '#C9A84C', fontSize: 28, marginBottom: 8 }}>{t.icon}</div>
                ...
                {step === 1 ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                    ...
                    <div>
                      ...
                      <input type="text" placeholder="EXAMPLE: $150,000" value={formData.priceExpectation} onChange={e => setFormData({...formData, priceExpectation: e.target.value})} style={{ width: '100%', background: '#f5f5f3', border: 'none', borderBottom: '2px solid #8B0000', padding: '14px', fontSize: 14, fontWeight: 700 }} />
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
                      <button type="submit" style={{ width: '100%', background: '#8B0000', color: '#fff', padding: '18px', borderRadius: 999, fontWeight: 900, fontSize: 18, border: 'none', cursor: 'pointer', textTransform: 'uppercase', letterSpacing: 1 }}>Submit My Property →</button>
