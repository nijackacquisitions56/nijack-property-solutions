...
const App = () => {
  ...
  const faqs = [
    ...
    { q: 'ARE THERE COMMISSIONS?', a: 'No. Because Tekton is not acting as your real estate agent, there are no agent commissions or Tekton service fees. Any normal closing-related charges, lien payoffs, taxes, or prorations are handled through the licensed Ohio title company and reviewed as part of the transaction.' },
    ...
    { q: 'IS THIS A LEGITIMATE PROCESS?', a: 'Tekton operates as a real estate wholesaler, not as a licensed real estate agent or broker. Depending on the property and circumstances, we may purchase the property ourselves or assign our contractual interest to another buyer for a profit. Every closing is handled through a licensed Ohio title company, which verifies ownership, coordinates the paperwork, and processes closing funds. Before any wholesale purchase agreement becomes binding, the property owner will receive the separate written Ohio Wholesaler Disclosure Statement required by law.' },
  ];
                    ...
                    <div id="field-contact-preferences" style={{ background: '#f8f6f2', border: '1px solid #e0d8c8', borderRadius: 16, padding: '24px 20px', scrollMarginTop: 110 }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        <div>
                          ...
                          <div className='pref-grid-2' style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 10 }}>
                            {['['Morning 9 AM–12 PM', 'Afternoon 12 PM–4 PM', 'Evening 4 PM–7 PM', 'Anytime', 'Text Me First']'].map((opt) => {
