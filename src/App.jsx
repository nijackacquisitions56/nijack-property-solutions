      ...
      <section className="hero-section" style={{ position: 'relative', color: '#fff', padding: '100px 20px 110px', borderBottom: '8px solid #C9A84C', textAlign: 'center', backgroundImage: 'url(https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1600&q=80)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 2 }}>
          ...
          <h1 style={{ fontSize: 'clamp(30px, 5vw, 56px)', fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.05, marginBottom: 20, letterSpacing: -1 }}>
            A <span style={{ color: '#C9A84C' }}>CASH</span> AS-IS SALE<br />On <span style={{ color: '#C9A84C' }}>YOUR</span> Timeline
          </h1>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 20 }}>
  ...
  <label style={{ display: 'block', fontWeight: 900, color: '#1a1a1a', marginBottom: 6, textTransform: 'uppercase', fontSize: 12, letterSpacing: 0.5, fontStyle: 'italic' }}>* Are you the current deed owner / titleholder?</label>
                      ...
                      {formData.deedOwner === 'Yes' && (
                        <div style={{ marginTop: 12 }}>
                          <input type="text" placeholder="Who is on the deed?" value={formData.deedOwnerNames} onChange={(e) => setFormData({ ...formData, deedOwnerNames: e.target.value })} style={{ width: '100%', background: '#f5f5f3', border: 'none', borderBottom: '2px solid #8B0000', padding: '14px', fontSize: 14, fontWeight: 700, boxSizing: 'border-box' }} />
                        </div>
                      )}
