...
const NijackSite = () => {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 leading-relaxed">
      ...
      <section className="bg-[#003366] text-white pt-10 pb-16 md:pt-14 md:pb-24 border-b-8 border-[#D4AF37]">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-7xl font-black mb-6 uppercase tracking-tighter leading-tight">
            ...
            <span className="relative inline-block text-[#D4AF37] px-1">CASH
      ...
      {/* 3. MAIN FORM - BROUGHT UP FOR HIGHER VISIBILITY */}
            ...
            <div className="p-6 md:p-14 space-y-8 md:space-y-12">
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <input type="text" placeholder="FULL NAME" className="w-full bg-gray-50 border-b-4 border-gray-200 p-4 font-black uppercase text-xs md:text-lg focus:border-[#003366] outline-none" required />
                  <input type="tel" placeholder="PHONE NUMBER" className="w-full bg-gray-50 border-b-4 border-gray-200 p-4 font-black uppercase text-xs md:text-lg focus:border-[#003366] outline-none" required />
                </div>
                <input type="text" placeholder="PROPERTY ADDRESS" className="w-
