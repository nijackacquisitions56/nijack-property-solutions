...
const App = () => {
  ...
  const situations = [const situations = ['Probate','Inherited','Divorce','Foreclosure','Tax Delinquent','Code Violations','Fire / Water Damage','Needs Repairs','Tired Landlord','Problem Tenant','Vacant','Expired Listing','Relocating','Health / Medical','Financial Hardship','Trust','Shopping Around','Other'];
