        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '48px 40px', border: '2px solid #e8e0d0', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28, fontSize: 15, lineHeight: 1.9, color: '#444', fontWeight: 600 }}>
            ...
            <section>
              ...
              <p style={{ margin: 0 }}>You opt in to receive SMS messages from Tekton Property Solutions LLC by checking the SMS consent checkbox on our property inquiry form at tektonpropertysolutions.com. Checking this box confirms your agreement to these SMS Terms &amp; Conditions.</p>
            ...
            <section>
              ...
              <p style={{ margin: 0 }}>You may opt out of receiving SMS messages from Tekton Property Solutions LLC at any time by replying <strong>STOP</strong> to any message you receive from us. After opting out, you will receive one final confirmation message and no further SMS messages will be sent.</p>
              <p style={{ margin: '10px 0 0' }}>You may also opt out by contacting us directly at:</p>
              <ul style={{ margin: '8px 0 0', paddingLeft: 24, display: 'flex', flexDirection: 'column', gap: 4 }}>
                <li>Email: nicole@tektonpropertysolutions.com</li>
                <li>Phone: 330-889-8983</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p style={{ margin: 0 }}>For assistance with our SMS program, reply <strong>HELP</strong> to any message you receive from us, or contact us directly at 330-889-8983 or nicole@tektonpropertysolutions.com.</p>
            </section>
